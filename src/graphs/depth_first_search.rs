...
pub fn depth_first_search(graph: &Graph, start: Vertex, end: Vertex) -> bool {
...
mod tests {
    ...
    fn finds_in_kn() {
        ...
        assert!(depth_first_search(&graph, 1.into(), 6.into()));
    }
    ...
    fn no_edge() {
        ...
        assert!(depth_first_search(&graph, 1.into(), 1.into()));
    }
    ...
    fn directed_right_edge() {
        ...
        assert!(depth_first_search(&graph, 1.into(), 2.into()));
    }
    ...
    fn island() {
        ...
        assert!(!depth_first_search(&graph, 1.into(), 10.into()));
    }
}
